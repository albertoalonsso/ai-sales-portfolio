...
return (
  <Section id="newsletter" className="bg-gradient-to-b from-background to-navy/10">
    <div className="max-w-5xl mx-auto">
      ...
      {/* 3 Blog Posts - Se muestran justo debajo del encabezado */}
      ...
      {/* Tarjeta de Newsletter con 2 columnas: Featured Topics y Signup Form */}
      <Card className="bg-navy text-white overflow-hidden border-white/10">
        <CardContent className="p-0">
          <div className="grid grid-cols-1 md:grid-cols-5">
            
            {/* Columna Izquierda - Featured Topics (se mantiene) */}
            ...
            {/* Columna Derecha - Formulario de Newsletter */}
